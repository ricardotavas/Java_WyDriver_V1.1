...
public class Send extends JFrame implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		case "Comando Próximo":
			pack = new Packet((byte) 255, (byte) 255, 'S', (byte) 51, (byte) 10, (int)BOX.getSelectedItem(), 3, new byte[] { 4,1,1 });
			...
			break;
		case "Comando Repete":
			pack = new Packet((byte) 255, (byte) 255, 'S', (byte) 51, (byte) 10, (int)BOX.getSelectedItem(), 3, new byte[] { 4,1,2 });
			sock.Send(IP.getText(), pack.getPacket());
			if (sock.getStatus()==Const.FRM_OK)
				STATUS.setText("Comunicação bem sucedida.");
			else
